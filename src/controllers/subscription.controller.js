...
const getSubscribedChannels = asyncHandler(async (req, res) => {
  ...
  const subscriptions = await Subscription.find({ subscriber: loggedInUserId })
...
const toggleSubscription = asyncHandler(async (req, res) => {
  ...
  if (channelId.toString() === loggedInUserId.toString()) {
  ...
  return res
    .status(200)
    .json(new ApiResponse(200, null, "Subscribed to channel"));
});
export {
    createPlaylist,
    updatePlaylist,
    ...
    toggleSubscription
};//pehle 7 faltu h wo playlist ke likh diye